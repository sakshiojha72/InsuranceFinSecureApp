...
public class InsuranceClaimController {
    ...
    public ResponseEntity<ClaimResponseDTO> raiseClaim(
        ...
        ClaimResponseDTO response =
            insuranceClaimService.raiseClaim(dto, employee.getUserId());
    ...
    public ResponseEntity<List<ClaimResponseDTO>> getMyClaims(
        ...
        List<ClaimResponseDTO> claims =
            insuranceClaimService.getEmployeeClaims(employee.getUserId());
    ...
    public ResponseEntity<List<ClaimResponseDTO>> getAllClaims(
        ...
        List<ClaimResponseDTO> claims =
            insuranceClaimService.getAllClaims(status);
    ...
    public ResponseEntity<List<ClaimResponseDTO>> getEmployeeClaims(
        ...
        List<ClaimResponseDTO> claims =
            insuranceClaimService.getEmployeeClaims(employeeId);
